...
function levelfog()
	...
	if fogtimer > 30 then
		...
		Level.underwater_fog.color.g = fogbrightness * 1.315
		Level.underwater_fog.color.b = fogbrightness * 1.5
	else
		...
		Level.underwater_fog.color.r = ((fogbrightness * mult) - fogbrightness) * 1.05
		Level.underwater_fog.color.g = ((fogbrightness * mult * 1.275) - (fogbrightness * .525))
		Level.underwater_fog.color.b = fogbrightness * mult * 1.5
